...
int
sprite_collision(struct sprite_struct* sprite1, int x1, int y1, struct sprite_struct* sprite2, int x2, int y2)
{
  ...
  if (leftx1 > leftx2 + sprite2->pixelmap->w)
    return 0;
  if (leftx1 + sprite1->pixelmap->w < leftx2)
    return 0;
  if (topy1 > topy2 + sprite2->pixelmap->h)
    return 0;
  if (topy1 + sprite1->pixelmap->h < topy2)
    return 0;
...
void
drawsprite(struct sprite_struct* thesprite, SDL_Surface* screen, int centrex, int centrey)
{
  int leftx, topy;
...
void
clearsprite(struct sprite_struct* thesprite, SDL_Surface* screen, int centrex, int centrey)
{
  int leftx, topy;
  SDL_Rect therect;
...
void
loadsprite(struct sprite_struct* thesprite, char* directory, char* filename, int width, int height, int hider, int hideb, int hideg, int nocollider, int nocollideg, int nocollideb)
{
  ...
  if (SDL_MUSTLOCK(thesprite->pixelmap))
    SDL_LockSurface(thesprite->pixelmap);
